...
export function JellyfishIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M4 11a8 8 0 0 1 16 0" />
      <path d="M4 11h16" />
      <path d="M5.5 11c0 1.3.9 1.7.9 3.2s-.9 1.9-.9 3.3" />
      <path d="M10 11c0 1.3.9 1.7.9 3.2s-.9 1.9-.9 3.3" />
      <path d="M14 11c0 1.3.9 1.7.9 3.2s-.9 1.9-.9 3.3" />
      <path d="M18.5 11c0 1.3.9 1.7.9 3.2s-.9 1.9-.9 3.3" />
    </svg>
  );
}

export function StarfishIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 2.5 14.6 9.1 21.5 9.6 16 14 18 20.8 12 16.8 6 20.8 8 14 2.5 9.6 9.4 9.1Z" />
    </svg>
  );
}

export function SeahorseIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M14 3c-1.8 0-3.2 1.4-3.2 3.2 0 1 .4 1.7.4 2.8 0 1.7-1.6 2-1.6 3.8 0 1.4 1 2.4 2.2 2.9-.8.4-1.3 1.1-1.3 2 0 1.4 1.2 2.3 2.7 2.3" />
      <path d="M14 3c.9 0 1.7.5 2 1.4" />
      <circle cx="12.6" cy="5.6" r="0.6" fill="currentColor" stroke="none" />
    </svg>
  );
}
