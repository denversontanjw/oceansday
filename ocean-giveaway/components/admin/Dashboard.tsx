      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-3">
          <input
            ...
            className="w-full max-w-sm rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm outline-none focus:border-ocean-500 focus:ring-2 focus:ring-ocean-300"
          />
          <a
